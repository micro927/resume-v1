...
function WelcomeSection({ personalInformation }: Props): JSX.Element {
    ...
    const myFullName = (`${name} ${surname}`).toUpperCase()
    const myAge = new Date(new Date().getTime() - bornDate.getTime()).getFullYear() - 1970;
    return (
        <section id='welcome' className='flex flex-col w-full scroll-mt-16  mb-12'>
            ...
            <div className='p-8 lg:p-16 rounded-2xl bg-slate-500 bg-opacity-10'>
                <div>
                    <div className="flex flex-col lg:flex-row w-100 h-full md:justify-between items-center">
                        ...
                        <div className='flex flex-col justify-center w-full lg:w-1/2 xl:w-5/12 px-4 text-sm sm:text-base mt-10 lg:mt-0  '>
                            ...
                            <div className='flex w-full justify-between items-center px-0 md:px-2 mb-3'>
                                <p className='text-lg font-bold'>Born</p>
                                <p>{bornDateString} ({myAge} Yrs.)</p>
                            </div>
                            <div className='flex w-full justify-between items-center px-0 md:px-2 mb-3'>
                                <p className='text-lg font-bold'>Hometown</p>
                                <p>{hometown}</p>
                            </div>
                        </div>
                    </div>
